...
class App extends Component {
    ...
    onAddApp = async () => {
        ...
        let response = await fetch("http://192.168.1.30:3000/api/main/vehicle/create", requestOptions);
        let res = await response.json();
        console.log(res);
        this.setState({ message: "Vehicle Registration: " + res.id + "\n" });
    };
        ...
        return (
            <div>
                ...
                <TextField
                    ...
                    label="Reg No"
                    variant="outlined"
                    value={this.state.vra.RegNo}
                    onChange={(event) => {
                        let vra = this.state.vra;
                        vra.RegNo = event.target.value;
                        this.setState({
                            vra,
                        });
                    }}
